...
export const users = [{ username: "user", password: "pass", role: "user" }];

export const category = [
  [
    { name: "Popular", val: "pop" },
    { name: "appliances", val: "app" },
    { name: "computers & tablets", val: "comp" },
    { name: "gaming console", val: "game" },
    { name: "telescope", val: "teles" },
  ],
  [
    { name: "all", val: "all" },
    { name: "sale", val: "sale" },
